...
<div class="container mt-5">
    ...
    <h1>Trabajo final BD1 - Parque de diversiones Agario City</h1>
    ...
    <div class="integrantes">
        <h2>Integrantes</h2>
        <ul>
            <li>Daniel Felipe Garzon Acosta</li>
            <li>Juan Felipe Miranda</li>
            <li>Tomas Murillo Aristizabal</li>
        </ul>
    </div>
    ...
    <div class="modelo">
        ...
        <p></p>
        <img src="MER-Modelo E-R punto 2.drawio.png">
    </div>

    <div class="enlaces">
        <h2>Enlaces</h2>
        <ul>
            <li><a href="cliente/cliente.php">Entidad MECANICO</a></li>
            <li><a href="empresa/empresa.php">Entidad TALLER</a></li>
            <li><a href="proyecto/proyecto.php">Entidad REPARACION</a></li>
